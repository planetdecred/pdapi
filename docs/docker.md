...
`docker build --squash -t planetdecred/pdapi:dev-alpine .`
...
`docker build --squash -f dockerfiles/Dockerfile_stretch -t planetdecred/pdapi:dev-stretch .`
...
`docker build --no-cache --squash -t planetdecred/pdapi:dev-alpine .`
...
- `docker build --squash -t planetdecred/pdapi:dev-alpine .` [Only build the container image if necessary](#building-the-image)
- `docker run --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/planetdecred/pdapi --rm planetdecred/pdapi:dev-alpine go build`
...
`docker run -e GOOS=darwin -e GOARCH=amd64 --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/planetdecred/pdapi --rm planetdecred/pdapi:dev-alpine go build`

`docker run -e GOOS=windows -e GOARCH=amd64 --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/planetdecred/pdapi --rm planetdecred/pdapi:dev-alpine go build`
...
`docker run -ti --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/planetdecred/pdapi --rm planetdecred/pdapi:dev-alpine /bin/bash`
...
`docker run -ti --entrypoint=/bin/bash -e DCRDATA_LISTEN_URL=0.0.0.0:2222 -v ${PWD}:/home/decred/go/src/github.com/planetdecred/pdapi --rm planetdecred/pdapi:dev-alpine`
...
`docker run -ti -p 2222:2222 -e DCRDATA_LISTEN_URL=0.0.0.0:2222 --rm planetdecred/pdapi:dev-alpine`
