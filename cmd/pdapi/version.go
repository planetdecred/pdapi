...
const (
	AppName  string = "pdapi"
	AppMajor uint   = 6
	AppMinor uint   = 0
	AppPatch uint   = 0
)

// go build -v -ldflags "-X github.com/planetdecred/pdapi/v5/version.appPreRelease= -X github.com/planetdecred/pdapi/v5/version.appBuild=`git rev-parse --short HEAD`"
var (
